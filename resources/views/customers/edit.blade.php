...
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <form action="{{ route('customers.update', $customer->id) }}" method="POST" id="kt_edit_customer_form" class="form">
                @csrf
                @method('PUT')
                        ...
                        <div class="row g-9">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control form-control-solid @error('name') is-invalid @enderror" 
                                    placeholder="{{ __('customers.name') }}" value="{{ old('name', $customer->name) }}" required />
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group input-group-solid">
                                    ...
                                    <input type="text" name="phone" class="form-control form-control-solid @error('phone') is-invalid @enderror" 
                                        placeholder="{{ __('customers.phone') }}" value="{{ old('phone', $customer->phone) }}" />
                                </div>
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-solid">
                                    ...
                                    <input type="email" name="email" class="form-control form-control-solid @error('email') is-invalid @enderror" 
                                        placeholder="{{ __('customers.email') }}" value="{{ old('email', $customer->email) }}" />
                                </div>
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-solid">
                                    ...
                                    <textarea name="address" class="form-control form-control-solid @error('address') is-invalid @enderror" 
                                        rows="3" placeholder="{{ __('customers.address') }}">{{ old('address', $customer->address) }}</textarea>
                                </div>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group input-group-solid">
                                    ...
                                    <textarea name="notes" class="form-control form-control-solid @error('notes') is-invalid @enderror" 
                                        rows="3" placeholder="{{ __('customers.notes') }}">{{ old('notes', $customer->notes) }}</textarea>
                                </div>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
...
@push('scripts')
    <script>
        // Form validation
        var form = document.getElementById('kt_edit_customer_form');
