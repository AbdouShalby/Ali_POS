        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{ __('users.create_user') }}</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card card-flush py-4">
                <div class="card-header">
                    <h2 class="card-title">{{ __('users.create_user') }}</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <!-- Password Field -->
                        <div class="mb-10">
                            <label for="password" class="form-label fw-bold">{{ __('users.password') }}</label>
                            <input
                                type="password"
                                class="form-control form-control-solid"
                                id="password"
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-success me-3">
                                <i class="bi bi-check-circle"></i> {{ __('users.save') }}
                            </button>
