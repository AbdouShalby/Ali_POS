        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    {{ __('external_purchases.create_external_purchase') }}
                </h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{ __('external_purchases.create_external_purchase') }}</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card card-flush py-4">
                <div class="card-header">
                    <h2 class="card-title">{{ __('external_purchases.create_external_purchase') }}</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('external_purchases.store') }}" method="POST">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-success me-3">
                                <i class="bi bi-check-circle"></i> {{ __('external_purchases.create') }}
                            </button>
