...
@section('content')
    <div class="container">
        <h3 class="mb-4">{{ __('reports.sales_report') }}</h3>
        ...
        <div class="mb-3 row">
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('reports.sales.export.pdf') }}" class="btn btn-danger mx-1">
                    <i class="fas fa-file-pdf"></i> {{ __('reports.export_pdf') }}
                </a>
                <a href="{{ route('reports.sales.export.excel') }}" class="btn btn-success mx-1">
