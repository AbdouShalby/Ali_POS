...
@section('content')
        ...
        <div class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{ __('suppliers.edit_supplier') }}</li>
                </ul>
            </div>
    ...
    <div class="app-content flex-column-fluid">
        <div class="app-container container-xxl">
            ...
            <form id="kt_supplier_edit_form" action="{{ route('suppliers.update', $supplier->id) }}" method="POST" class="form">
                @csrf
                @method('PUT')
                            ...
                            <div class="col-md-6 mb-7">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" 
                                              name="address" rows="1"
                                              placeholder="{{ __('suppliers.address') }}">{{ old('address', $supplier->address) }}</textarea>
                                </div>
                                @error('address')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              name="notes" rows="3"
                                              placeholder="{{ __('suppliers.notes') }}">{{ old('notes', $supplier->notes) }}</textarea>
                                </div>
                                @error('notes')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
...
<script>
    // Form Validation
    var form = document.getElementById('kt_supplier_edit_form');
