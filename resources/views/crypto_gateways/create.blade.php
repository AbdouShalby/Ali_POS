...
@section('title', __('crypto_gateways.create_gateway'))
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                    {{ __('crypto_gateways.create_gateway') }}
                </h1>
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">{{ __('crypto_gateways.create_gateway') }}</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="card card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    <div class="card-title">
                        <h2 class="mb-0">{{ __('crypto_gateways.create_gateway') }}</h2>
                    </div>
                </div>
                    ...
                    <form action="{{ route('crypto_gateways.store') }}" method="POST">
                        ...
                        <div class="mb-10">
                            ...
                            <input type="text" 
                                   ...
                                   name="name" 
                                   value="{{ old('name') }}" 
                                   placeholder="{{ __('crypto_gateways.name_placeholder') }}"
                                   required />
                            @error('name')
