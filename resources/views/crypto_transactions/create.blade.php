    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 mx-5">
                <form action="{{ route('crypto_transactions.store', $gateway->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="fees" name="fees" step="0.00000001" required>
                    </div>
            ...
            <div class="col-md-3">
                <!-- الكمية -->
                <div class="mb-3">
                    <label for="amount" class="form-label">النسبة</label>
                    <input type="number" class="form-control" id="amount" name="amount" step="0.00000001" required>
                </div>

                <!-- الكمية -->
                <div class="mb-3">
                    <label for="amount" class="form-label">نتيجة النسبة</label>
                    <input type="number" class="form-control" id="amount" name="amount" step="0.00000001" required readonly>
                </div>
            </div>
        </div>
    </div>
